...
graphene_matrix_t
get_hmd_matrix (Gst3DCamera * self, ohmd_float_value type)
{
  float matrix[16];
...
gst_3d_camera_update_view_from_quaternion (Gst3DCamera * self)
{
  ...
  graphene_matrix_t left_eye_projection =
      get_hmd_matrix (self, OHMD_LEFT_EYE_GL_PROJECTION_MATRIX);


  graphene_matrix_t right_eye_model_view;
  graphene_matrix_t right_eye_projection =
      get_hmd_matrix (self, OHMD_RIGHT_EYE_GL_PROJECTION_MATRIX);
...
gst_3d_camera_update_view_from_matrix (Gst3DCamera * self)
{
  ...
  graphene_matrix_t left_eye_model_view =
      get_hmd_matrix (self, OHMD_LEFT_EYE_GL_MODELVIEW_MATRIX);
  graphene_matrix_t left_eye_projection =
      get_hmd_matrix (self, OHMD_LEFT_EYE_GL_PROJECTION_MATRIX);

  graphene_matrix_t right_eye_model_view =
      get_hmd_matrix (self, OHMD_RIGHT_EYE_GL_MODELVIEW_MATRIX);
  graphene_matrix_t right_eye_projection =
      get_hmd_matrix (self, OHMD_RIGHT_EYE_GL_PROJECTION_MATRIX);
...
gst_3d_camera_translate_arcball (Gst3DCamera * self, float z)
{
  ...
  GST_ERROR("center distance: %f", self->center_distance);
  // updateView();
...
gst_3d_camera_update_view_arcball (Gst3DCamera * self)
{
  ...
  */
  ...
  graphene_vec3_init (&eye,
      ...
      radius * sin (self->phi) * sin (self->theta));
  ...
  */
  ...
  graphene_matrix_t projection_matrix;
  graphene_matrix_init_perspective (&projection_matrix,
      90.0, 4.0 / 3.0, self->znear, self->zfar);
